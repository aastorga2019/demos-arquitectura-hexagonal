Se envía una petición HTTP con los datos de un empleado, y se recibe un response con los mismos datos enviados, además de dejar también la respuesta en un tópico de Pub/Sub.
